...
interface ResultsData {
  ...
  cumac?: {
    prices: Array<{ qmac: number | null; has_surface: boolean }>
...
/**
 * Displays CUMAC + ANAH results for a meeting.
 * Mirrors the Symfony template: app_domoprime_iso3_ajaxResultsForMeeting.tpl
 * and follows the same pattern as TabIso3Results.tsx for contracts.
 *
 * Sections:
  ...
  if (!results.has_polluter) {
    return (
      <Alert severity='info' sx={{ mb: 2 }}>
        Aucun pollueur assigné à ce rendez-vous.
      </Alert>
    )
  }
          ...
          <>
            ...
            {engine_type ? (
              <Alert severity='warning' sx={{ mb: 1 }}>
                {engine_type}: Le tarif n&apos;existe pas.
              </Alert>
            ) : null}
